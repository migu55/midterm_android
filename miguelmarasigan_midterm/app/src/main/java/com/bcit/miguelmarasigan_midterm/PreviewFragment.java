...
public class PreviewFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView textView = view.findViewById(R.id.textView_preview);
        ImageView imgView = view.findViewById(R.id.imageView_preview);
        textView.setText(mParam1.getName());
        imgView.setImageResource(mParam1.getResId());
    }
}